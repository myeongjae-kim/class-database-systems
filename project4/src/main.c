...
void join_testing() {
  ...
  int table_id_1 = open_table("db_10k");
  int table_id_2 = open_table("db_odd10k");


  /** printf("print_all: table_id_1 \n"); */
  /** print_all(table_id_1); */
  /** printf("print_all: table_id_2 \n"); */
  /** print_all(table_id_2); */


  join_table(table_id_1, table_id_2, "join_result");
}
